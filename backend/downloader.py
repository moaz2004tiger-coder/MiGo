...
# تحديث دالة جلب المعلومات لاستقبال التوكنات
    ...
    ydl_opts = {
        ...
        'extractor_args': {
            'youtube': {
                ...
                # حقن التوكنات في عملية جلب البيانات
...
# تحديث دالة المهمة لاستقبال التوكنات
def download_media_task(task_id: str, url: str, dl_type: str, quality: str, lang: str = None, po_token: str = None, visitor_data: str = None):
    ...
    ydl_opts = {
        ...
        'extractor_args': {
            'youtube': {
                'player_client': ['android', 'web_safari'],
                'formats': 'duplicate,missing_pot',
                # حقن التوكنات في عملية التحميل الفعلي
                'po_token': [po_token] if po_token else [],
                'visitor_data': [visitor_data] if visitor_data else []
            }
        }
    ...
    is_playlist = False
    try:
        # ملاحظة: يجب أيضاً تمرير التوكنات هنا عند فحص قوائم التشغيل
        check_opts = {
            'quiet': True, 
            'extract_flat': 'in_playlist',
